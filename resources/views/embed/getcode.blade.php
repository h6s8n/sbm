...
responsiveStartStr += '<div class="h_iframe-zibatran_embed_frame"> <span style="display: block;padding-top: 56.2%"></span><div style="display:none"><h2><a href="https://sbm24.com/{{ $user->username }}">‌{{ $user->doctor_nickname . ' ' . $user->fullname }}</a></h2></div>';
...
newiframe.setAttribute('src','{{ url('embed/' .  $user->username) }}');
setTimeout(function(){
