...
<head>
    ...
    <link href="{!! asset('assets/adminui/plugins/bower_components/html5-editor/bootstrap-wysihtml5.css') !!}" rel="stylesheet" :sty >
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part">
                    <a class="logo" href="{{ url('/cp-manager') }}">
                        <span class="hidden-xs">
                                <img src="{!! asset('assets/adminui/plugins/images/logo_text.png') !!}" style="width: 45%; margin-top: -13px;" alt="home" class="light-logo" />
                        </span>
                    </a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        ...
                        $user_name = $user->name;
                        ?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <b><?php echo $user_name.' عزیز خوش آمدید ...'; ?></b> </a>
                        <ul class="dropdown-menu animated flipInY">
                            <li><a href="{{ url('cp-manager/profile') }} }}"><i class="ti-user"></i> My Profile</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ url('cp-manager/logout') }}"><i class="fa fa-power-off"></i> Logout</a></li>
                        </ul>
