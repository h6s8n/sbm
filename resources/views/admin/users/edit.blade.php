    ...
    <div class="white-box">
        ...
        <form method="post" action="" enctype="multipart/form-data" class="avatar" style="direction: rtl">
            ...
            <div class="form-group row">
                <label for="name" class="col-md-4 col-form-label text-md-right">لینک همکاری در فروش	</label>

                <div class="col-md-6">
                    {{ 'https://sbm24.com/?affiliate_tag=' . $request->token }}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="family" type="text" class="form-control{{ $errors->has('family') ? ' is-invalid' : '' }}" name="family" value="{{ old('family', $request->family) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mobile" type="text" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile', $request->mobile) }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="nationalcode" type="text" class="form-control{{ $errors->has('nationalcode') ? ' is-invalid' : '' }}" name="nationalcode" value="{{ old('nationalcode', $request->nationalcode) }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-3 col-md-2">
                    @if($request->picture)
                        <a style="margin-top: 11px; display: inline-block; font-size: 14px;" href="{{ $request->picture }}" target="_blank">مشاهده تصویر</a>
                    @else
                ...
                <div class="col-md-6">
                    <div class="radio radio-info">
                        <div style="display: inline-block; margin-right: 15px">
                            <input type="radio" id="status_active" name="status" value="active" {{ ( old('status', $request->status) == 'active') ? "checked" : "" }}>
                            <label for="status_active">فعال</label>
                        </div>
                        <div style="display: inline-block; margin-right: 15px">
                            <input type="radio" id="status_inactive" name="status" value="inactive" {{ ( old('status', $request->status) == 'inactive') ? "checked" : "" }}>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="radio radio-info">
                        <div style="display: inline-block; margin-right: 15px">
                            <input type="radio" id="gender_active" name="gender" value="0" {{ ( old('gender', $request->gender) == '0') ? "checked" : "" }}>
                            <label for="gender_active">مرد</label>
                        </div>
                        <div style="display: inline-block; margin-right: 15px">
                            <input type="radio" id="gender_inactive" name="gender" value="1" {{ ( old('gender', $request->gender) == '1') ? "checked" : "" }}>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="job_title" type="text" class="form-control{{ $errors->has('job_title') ? ' is-invalid' : '' }}" name="job_title" value="{{ old('job_title', $request->job_title) }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="bio" type="text" class="form-control{{ $errors->has('bio') ? ' is-invalid' : '' }}" name="bio" value="{{ old('bio', $request->bio) }}" >
            ...
            <div class="form-group row">
                <label for="credit" class="col-md-4 col-form-label text-md-right">اعتبار کاربر</label>

                <div class="col-md-6">
                    <input id="credit" type="text" class="form-control{{ $errors->has('credit') ? ' is-invalid' : '' }}" value="{{ old('credit', $request->credit) }}" name="credit" >
