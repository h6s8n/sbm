...
{{--    {{dd($errors)}}--}}
    <div class="white-box">
        <div class="alert alert-danger">
            <p>
                عنوان صفحه اختصاصی برای پزشکان جدید با این فرمت:دکتر-اسم-فامیل (دکتر-محمد-رضا-علی-یاری)
            </p>
        </div>
        <form method="post" action="" enctype="multipart/form-data" class="avatar" style="direction: rtl">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="sp_gp" class="form-control js-example-basic-multiple{{ $errors->has('sp_gp') ? ' is-invalid' : '' }}" name="sp_gp[]" multiple>
            ...
            <div class="form-group row">
                <label for="username" class="col-md-4 col-form-label text-md-right">عنوان صفحه اختصاصی:دکتر-اسم-فامیل (دکتر-محمد-رضا-علی-یاری)</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="en_url" type="text" class="form-control{{ $errors->has('en_url') ? ' is-invalid' : '' }}" name="en_url" value="{{ old('en_url') }}" >
            ...
            <div class="form-group row" style="display: flex;flex-grow: 1;flex-wrap: wrap">
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_doctor" name="code_title" value="شماره نظام پزشکی" {{ ( old('code_title') == 'شماره نظام پزشکی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_nurse" name="code_title" value="شماره نظام پرستاری" {{ ( old('code_title') == 'شماره نظام پرستاری') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_midwifery" name="code_title" value="شماره نظام مامایی" {{ ( old('code_title') == 'شماره نظام مامایی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_physiotherapy" name="code_title" value="شماره نظام فیزیوتراپی" {{ ( old('code_title') == 'شماره نظام فیزیوتراپی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_nutrition" name="code_title" value=" شماره نظام تغذیه" {{ ( old('code_title') == ' شماره نظام تغذیه') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_treatment" name="code_title" value="شماره نظام  کاردرمانی" {{ ( old('code_title') == 'شماره نظام  کاردرمانی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_psychology" name="code_title" value="شماره نظام روانشناسی" {{ ( old('code_title') == 'شماره نظام روانشناسی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_psychology" name="code_title" value="شماره نظام داروسازی" {{ ( old('code_title') == 'شماره نظام داروسازی') ? "checked" : "" }}>
                ...
                <div class="col-md-3">
                    <div class="radio radio-info">
                        <div>
                            <input type="radio" id="code_title_psychology" name="code_title" value="شماره نظام شنوایی سنجی" {{ ( old('code_title') == 'شماره نظام شنوایی سنجی') ? "checked" : "" }}>
