...
@section('page_name', 'افزودن بیمارستان جدید')
...
@section('content')
    ...
    <div class="white-box">
        ...
        <form method="post" action="{{route('partner.store')}}" class="avatar" style="direction: rtl" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="sheba" type="text" class="form-control {{ $errors->has('sheba') ? ' is-invalid' : '' }}"
                           name="sheba" value="{{ old('sheba') }}" maxlength="24" minlength="24">
                    @if ($errors->has('sheba'))
                        <span class="invalid-feedback">
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-9 col-md-6">
                    <input id="logo" type="file" class="form-control{{ $errors->has('logo') ? ' is-invalid' : '' }}"
                           name="logo">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="doctor_percent" type="text" class="form-control {{ $errors->has('doctor_percent') ? ' is-invalid' : '' }}"
                           name="doctor_percent" value="{{ old('doctor_percent') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="partner_percent" type="text" class="form-control {{ $errors->has('partner_percent') ? ' is-invalid' : '' }}"
                           name="partner_percent" value="{{ old('partner_percent') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="service_id" class="form-control js-example-basic-multiple{{ $errors->has('service_id') ? ' is-invalid' : '' }}" name="service_id[]" multiple>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="insurance_id" class="form-control js-example-basic-multiple{{ $errors->has('insurance_id') ? ' is-invalid' : '' }}" name="insurance_id[]" multiple>
                        {{--                        <option value="">لطفا انتخاب کنید</option>--}}
