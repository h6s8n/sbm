...
@section('page_name', 'ویرایش نشان ')

@section('content')

    <div class="white-box">

        <form method="post" action="{{route('badge.update',$badge)}}" class="avatar" style="direction: rtl" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group row">
                <label for="name" class="col-md-4 col-form-label text-md-right">عنوان نشان </label>
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name',$badge->name)}}">
                    @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="priority" type="text" class="form-control {{ $errors->has('priority') ? ' is-invalid' : '' }}"
                           name="priority" value="{{ old('priority',$badge->priority) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="description" type="text"
                              ...
                              name="description">{{ old('description',$badge->description) }}</textarea>
            ...
            <div class="form-group row mb-0">
                <div class="col-md-6 offset-md-4">
                    <button type="submit" class="btn btn-info waves-effect waves-light">ویرایش نشان</button>
                </div>
            </div>
