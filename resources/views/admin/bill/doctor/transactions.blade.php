...
@section('page_name', 'تراکنش های اخیر')
        ...
        <div class="white-box">
            ...
            <div class="portlet-body">
                ...
                @if(isset($request['data']) && count($request['data']) > 0)
                    ...
                    @php $url = str_replace('&page='.request()->get('page'),'',request()->fullUrl()) ; @endphp

                    <ul class="pagination" role="navigation">
                        <li class="page-item" aria-disabled="true" aria-label="&laquo; Previous">
                            <a name="page" @if($request['prev_page_url']) href="{{$url.$simbol.$request['prev_page_url']}}" class="page-link" @else class="disable" @endif rel="prev" aria-label="&lsaquo; Previous">&lsaquo;</a>
                        </li>

                        <li class="page-item">
                            <a name="page" @if($request['next_page_url']) class="page-link" href="{{$url.$simbol.$request['next_page_url']}}" @else class="dissable" @endif rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                        </li>
                    </ul>
                    <div class="clearfix"></div>
