...
@section('page_name', 'تراکنش های ناموفق')

@section('content')

    <div class="white-box">

        <form method="post" action="{{route('transactionReserve.update',$request)}}" class="avatar" style="direction: rtl" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
