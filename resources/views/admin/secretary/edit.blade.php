...
@section('content')
    ...
    <div class="white-box">
        <form method="post" action="{{route('secretary.update',$secretary->id)}}" class="avatar" style="direction: rtl">
            {{ csrf_field() }}
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="full_name" type="text" class="form-control {{ $errors->has('full_name') ? ' is-invalid' : '' }}"
                           name="full_name" value="{{ $secretary->full_name}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mobile" type="text" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}"
                           name="mobile" value="{{  $secretary->mobile}} ">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="username" type="text"
                           class="form-control" name="username" value="{{$user->mobile}}" readonly/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="password" type="text"
                           ...
                           name="password" value="{{ $secretary->password}}"/>
                </div>
            </div>
